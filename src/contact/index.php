...
<body>
    ...
    <div class="wrapall mt-5">
        <!-- PROJECTS CONTENT HERE -->
        <section>
            <div class="container h-100 mt-5">
                <div class="contact-section row d-flex align-items-center mb-5">
                    <div class="contact-details col-lg-6 col-sm-12 p-5">
                        <div class="contact-text row">
                            <h2 class="contact-title"> <?php echo $txt_title ?> </h2>
                            <p class="contact-desc mt-4"> <?php echo $txt_p ?> </p>
                        </div>
                        <div class="contact-phone-email row p-5">
                            <div class="contact-phone col-md-6 col-sm-12">
                                <div class="row">
                                    <div class="contact-icon col-2 d-flex justify-content-end">
                                        <img src="../images/icons/icon-phone.webp" style="height: 32px" alt="phone-icon">
                                    </div>
                                    <div class="col-10 ps-5">
                                        <p class="sub-title">Phone</p>
                                        <p class="sub-desc">(074) 244 5185</p>
                                    </div>
                                </div>
                            </div>
                            <div class="contact-email col-md-6 col-sm-12">
                                <div class="row">
                                    <div class="contact-icon col-2 d-flex justify-content-end">
                                        <img src="../images/icons/icon-email.webp" alt="email-icon">
                                    </div>
                                    <div class="col-10 ps-5">
                                        <p class="sub-title">Email</p>
                                        <p class="sub-desc"> <?php echo $contact_email ?> </p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="contact-social row">
                            <div class="col-6 pt-3">
                                <button type="button" onclick="parent.open('https://www.facebook.com/bitshareslabs')" class="contact-btn contact-btn-facebook">Facebook</button>
                            </div>
                            <div class="col-6 pt-3">
                                <button type="button" onclick="parent.open('https://twitter.com/bitshareslabs')" class="contact-btn contact-btn-twitter">Twitter</button>
                            </div>
                            <div class="col-6 pt-3">
                                <button type="button" onclick="parent.open('https://www.instagram.com/bitshareslabs/')" class="contact-btn contact-btn-instagram">Instagram</button>
                            </div>
                            <div class="col-6 pt-3">
                                <button type="button" onclick="parent.open('https://www.linkedin.com/company/bitshareslabs')" class="contact-btn contact-btn-linkedin">Linkedin</button>
                            </div>
                            <div class="col-12 pt-3">
                                <button type="button" onclick="parent.open('https://medium.com/@bitshareslabs')" class="contact-btn contact-btn-medium">Medium</button>
                            </div>
                        </div>
                        <div class="row contact-address mt-5 pt-4">
                            <div class="row">
                                <div class="contact-icon col-2 d-flex justify-content-end">
                                    <img src="../images/icons/icon-location.webp" style="height: 32px" alt="lcoation-icon">
                                </div>
                                <div class="col-10">
                                    <p>Unit 2 BLINC Business Center, Orchids St., San Luis Village, Baguio City, Philippines 2600</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="contact-map col-lg-6 col-sm-12 d-flex justify-content-center p-5">
        ...
        <section>
            <div class="h-100 gradient-bg">
                <div class="form-section row d-flex justify-content-center mt-5">
                    <div class="form-text col-md-5 col-sm-12">
                        <h2 class="form-title"> <?php echo $contact_title ?> </h2>
                        <p class="form-desc mt-5"> <?php echo $contact_sub ?> </p>
                    </div>
                    <div class="form-container col-md-7 col-sm-12">
                        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                            <div class="form-contents row p-5">
                                <div class="form-input col-lg-6 col-sm-12 form-floating p-2">
                                ...
                                <div class="form-input col-lg-6 col-sm-12 form-floating p-2">
                                    <input type="tel" pattern="[0-9]{11}" maxlength="11" class="form-control" placeholder="Contact" id="contact" name="contact" required>
                                    <label for="contact" class="form-label">Contact</label>
                                </div>
                                <div class="form-input col-lg-6 col-sm-12 form-floating p-2">
                                    <input type="text" class="form-control" placeholder="<?php echo $phl_occupation ?>" name="occupation" id="occupation">
                                    <label for="occupation" class="form-label"><?php echo $phl_occupation ?></label>
                                </div>
                                <div class="form-input col-lg-6 col-sm-12 form-floating p-2">
                                    <input type="text" class="form-control" placeholder="<?php echo $phl_company ?>" name="company" id="company">
                                    <label for="company" class="form-label"><?php echo $phl_company ?></label>
                                </div>
                                <div class="form-input col-lg-12 col-sm-12 form-floating p-2">
                                    <input type="text" class="form-control" placeholder="Subject" id="subject" value="<?php echo $subjectform ?>" name="subject" required>
                                    <label for="subject" class="form-label">Subject</label>
                                </div>
                                <div class="form-input col-lg-12 col-sm-12 form-floating p-2">
                                    <textarea type="text" class="form-control" placeholder="Message" id="message" style="height: 20rem" name="msg_content" required></textarea>
                                    <label for="message" class="form-label text-a">Message</label>
                                </div>
                            </div>
                            <div class="form-button row ps-5 pe-5 pb-5">
                                <div class="g-recaptcha" data-sitekey="6LcVCRclAAAAAPa1tGtmgjyXkWfmVa9UUkNqv5FJ"></div>
                                <button type="submit" name="submit" value="Submit" class="default-btn">Submit Message</button>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyALrmo-mLnhrrz5qvYIIihbiAeNvp120lE&callback=initMap&v=weekly" defer></script>
